...
if (shiftbegin){
  ...
  if (t1_i[1] == 1){
    t1_i[1] <- 3 # if first data point is beginning of gap, dt cannot be estimated from the former continuous series, but is estimated from the next continuous series
